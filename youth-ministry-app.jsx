...
// Icons are now defined inline in index.html
      ...
      <style>{`
        ...
        * {
        ...
        :root {
          ...
          --shadow-md: rgba(139, 69, 19, 0.12);
          --shadow-lg: rgba(139, 69, 19, 0.16);
        }
        ...
        .app-container {
          display: flex;
          min-height: 100vh;
          background: linear-gradient(135deg, #FAF8F3 0%, #F5EFE7 100%);
        }
        ...
        .stat-accent .stat-icon {
          background: linear-gradient(135deg, var(--accent) 0%, #3A5F5F 100%);
        }

        .stat-warning .stat-icon {
          background: linear-gradient(135deg, var(--warning) 0%, #E5B80B 100%);
        }
        ...
        .sidebar-student.active .student-avatar-sm {
        ...
        /* Rotations & Visitations */
        .rotations-calendar, .visitations-grid {
          background: var(--bg-paper);
          border: 1px solid var(--border);
          border-radius: 16px;
          padding: 2rem;
